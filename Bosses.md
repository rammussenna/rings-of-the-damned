...
* **Fight Mechanics**:
  ...
  * The arena shifts with statues that give you either a buff or debuf you
...
* **Abilities**:
  ...
  * **Siren's Echo**: Fires charm projectiles that cause player to not be able to dodge for 2 seconds
  * **Mirage Split**: Splits into three mirages. All must be killed quickly or she regenerates health.
  * **Temptation Bloom**: Area-of-effect pulse that lowers player defenses temporarily.
...
* **Abilities**:
  ...
  * **Golden Hoard**: Summons animated gold to block paths or attack.
...
* **Fight Mechanics**:
  ...
  * Loot is bait, grabbing it powers him up unless cleansed first.
...
* **Abilities**:
  ...
  * **Chain Smash**: Mid-range flail slam that burns causes area of effect damage that lasts for 2 seconds on the ground.
...
* **Fight Mechanics**:
  ...
  * Becomes far more dangerous under 50% HP (50% bonus damage).
...
* **Abilities**:
  ...
  * **Scripture Rewrite**: Inverts player controls temporarily for 10 seconds if hit.
  * **Hellfire Veil**: Covers arena in blasphemous fire causing damage overtime if stepped in.
  * **Mark of Blasphemy**: Reduces player HP by 50% and armor by 20% if hit.
* **Fight Mechanics**:
...
* **Abilities**:
  ...
  * **Weapon Harvest**: Rips weapons from its own body and throws, if hit the player staggers for 2 seconds.
...
- **God** – Spiritual rebellion
- **Mankind** – Manipulation and deception
- **Self** – Nihilism and despair

##  Boss Phases

### Phase 1: “The Frozen Pact”
- Lucifer remains half-submerged in the lake.
- Attacks are delayed but cover wide areas.
- **Mechanics**:
  - **Ice Spike Trails**: Each time the player dodges, ice spikes erupt where they moved — punishing panic-dodging.
  - **Memory Echoes**: Lucifer clones the player’s **past moves**, creating “ghost” attacks that repeat your previous parry, dash, or strike several seconds later.
  - **Deceptive Dialogue**: He mimics a trusted mentor’s voice (randomized from earlier NPCs), psychologically disarming the player.


### Phase 2 (Below 70% HP): “Shattered Wings”
- Lucifer tears open his wings, summoning **two angelic wraiths** resembling fallen versions of **Michael** and **Gabriel**.
- **Mechanics**:
  - **Wraith Guardians**: These wraiths absorb damage for Lucifer and must be separated and defeated to weaken his defense.
  - **Mirror Teleportation**: Lucifer teleports through cracked mirrors around the arena — fake reflections will attack, while the real one stays hidden.
  - **Unstable Arena**: The battlefield becomes fractured, with pieces of the frozen lake floating mid-air.

---

### Phase 3 (Below 25% HP): “Judgment Deferred”
- Lucifer breaks free of the ice. His wings ignite in divine fire. The arena turns into a raging inferno.
- **Mechanics**:
  - **Triple Speed**: Lucifer’s speed and aggression triple.
  - **Arena Collapse**: The world breaks down into a space-like void. Floating debris can be used for cover or traversal.
  - **Sound Descent**: All sound is muffled except for the player’s heartbeat and Lucifer’s breathing.
  
##  Unique Mechanic: Betrayal Counter

Lucifer becomes stronger based on the **Betrayal Counter**, a hidden system that tracks:
- Sparing enemies
- Using cursed items
- Trusting certain NPCs or being manipulated

### High Betrayal Counter:
- Lucifer gains more abilities and taunts the player with personalized lines.

### Low Betrayal Counter:
- Lucifer is slightly weaker.
- Some NPCs return to assist during his final phase.

This system ensures that every decision made in the game echoes into the final confrontation.

##  Mini-Bosses (Treachery)

### 1. Judas Ascended
- **Type**: Assassin
- **Weapons**: Dual cursed daggers
- **Behavior**:
  - Rapid teleportation and shadow slashes.
  - May take the form of a **spared ally** from earlier, creating a moral dilemma.
- **Consequences**:
  - Killing the “fake ally” version can permanently alter the ending.

---

### 2. The Faithless Knight
- **Type**: Betrayer Tank
- **Intro**: Wears your faction’s armor, appears friendly during a cutscene, then **stabs you mid-dialogue**.
- **Abilities**:
  - Heavy shield bashes, unblockable charge attacks.
  - Uses corrupted version of your own combat techniques.
- **Drop**: **“Broken Oathplate”** — boosts defense but causes **HP decay when allies are nearby**.

---

## 📦 Rewards

- **Lucifer’s Trident (Weapon)** – A slow, high-damage polearm with soul-siphoning effects.
- **Winged Halo (Equippable)** – Grants triple jump and slow-fall, but permanently reduces max HP by 10%.
- **Memory Echo (Passive)** – Allows the player to **replay one combat encounter per run** with all knowledge retained.
