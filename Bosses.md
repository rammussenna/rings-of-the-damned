...
* **Abilities**:
  ...
  * **Lustbound Spawn**: At 20% HP, summons other Lust-based enemies. She can kill them herself to absorb their energy gaining hp.
* **Fight Mechanics**:
...
* **Abilities**:
* **GREEDINESS**:Archon, summons golden ingots, which over time lures in minions, causing massive crowds (and may spawn in pass mini bosses 1/256) (balagtas reco)
...
* **Abilities**:
  ...
  * **Rage Flood**: Gains attack speed and movement under 30% HP.
...
- **Mechanics**:
  ...
  - **Mirror Teleportation**: Lucifer teleports around the arena — fake reflections will attack, while the real one stays hidden.
